...
export const metadata = { title: "Ingresar — Consultorio" };
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-sm flex-col justify-center px-6">
      <div className="mb-8 text-center">
        ...
        <h1 className="text-2xl font-bold">Acceso al consultorio</h1>
        <p className="mt-1 text-sm text-neutral-500">Odontólogos y recepción</p>
      </div>
      {error && (
